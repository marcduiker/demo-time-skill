...
- **Never invent action names, layout names, theme names, or CSS variables.** If you need something the bundled references don't cover, WebFetch the canonical page first and add it to the appropriate reference file.
